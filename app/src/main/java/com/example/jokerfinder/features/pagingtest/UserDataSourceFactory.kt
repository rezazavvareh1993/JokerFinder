 ...
 */
class UserDataSourceFactory(private val viewModelScope: CoroutineScope, private val searchedName: String, private val apiKey: String) : DataSource.Factory<Int, ResultModel>() {
    val userLiveDataSource = MutableLiveData<UserDataSource>()
    override fun create(): DataSource<Int, ResultModel> {
        val userDataSource =
            UserDataSource(viewModelScope ,searchedName, apiKey)
